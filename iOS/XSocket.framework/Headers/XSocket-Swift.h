...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="XSocket",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// warning:
/// This class is not thread-safe, it is expected that the instance is accessed on the <code>queue</code> only.
SWIFT_CLASS("_TtC7XSocket12GCDTCPSocket")
...
SWIFT_CLASS("_TtC7XSocket12GCDUDPSocket")
...
@interface GCDUDPSocket (SWIFT_EXTENSION(XSocket)) <GCDAsyncUdpSocketDelegate>
...
SWIFT_CLASS("_TtC7XSocket11NWTCPSocket")
...
SWIFT_CLASS("_TtC7XSocket11NWUDPSocket")
