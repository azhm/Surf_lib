...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AxLogger",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC8AxLogger11AxEnvHelper")
...
+ (NSString * _Nonnull)deviceLocalizedModel SWIFT_WARN_UNUSED_RESULT;
+ (NSString * _Nonnull)phoneIdentifier SWIFT_WARN_UNUSED_RESULT;
+ (NSString * _Nonnull)appIdentifier SWIFT_WARN_UNUSED_RESULT;
+ (NSString * _Nonnull)screenSize SWIFT_WARN_UNUSED_RESULT;
+ (NSString * _Nonnull)carrier SWIFT_WARN_UNUSED_RESULT;
+ (NSString * _Nonnull)networkType SWIFT_WARN_UNUSED_RESULT;
+ (NSDictionary<NSString *, NSString *> * _Nonnull)infoDict SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

enum AxLoggerLevel : NSInteger;

SWIFT_CLASS("_TtC8AxLogger8AxLogger")
...
+ (void)enableConsoleWithEnable:(BOOL)enable;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

typedef SWIFT_ENUM(NSInteger, AxLoggerLevel) {
  AxLoggerLevelError = 0,
  AxLoggerLevelWarning = 1,
  AxLoggerLevelInfo = 2,
  AxLoggerLevelNotify = 3,
...
@interface NSString (SWIFT_EXTENSION(AxLogger))
- (uint64_t)fileSize SWIFT_WARN_UNUSED_RESULT;
- (BOOL)fileExist SWIFT_WARN_UNUSED_RESULT;
- (BOOL)dirCreate SWIFT_WARN_UNUSED_RESULT;
- (BOOL)fileDelete SWIFT_WARN_UNUSED_RESULT;
@end
